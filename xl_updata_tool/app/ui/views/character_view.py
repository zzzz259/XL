...
def create_character_view(parent=None):
    ...
    character_status.setStyleSheet(f"color:{TEXT_SECONDARY}; font-size:12px; background:transparent; padding-left:16px;")
    ...
    character_table.setShowGrid(False)
    ...
    character_detail_name.setStyleSheet(f"color:{TEXT_PRIMARY}; font-size:18px; font-weight:bold; background:transparent;")
    detail_layout.addWidget(character_detail_name)

    character_detail_info = QLabel("")
    character_detail_info.setWordWrap(True)
    character_detail_info.setStyleSheet(f"color:{TEXT_SECONDARY}; font-size:13px; background:transparent;")
    ...
    character_empty.setStyleSheet(f"color:{TEXT_MUTED}; font-size:16px; background:transparent;")
